...
import com.santaanna.friendlyreader.summarization.util.IndexHelperHelper;
 ...
 * @author christian
 */
public class CoherenceRevision extends SummaryRevision{
    public CoherenceRevision(SummaryReader reader){
        super(reader);
    }
